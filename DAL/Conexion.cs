...
namespace DAL
{
    public class Conexion
    {
        ...
        {   // HACK: Cadena de conexión hardcodeada. Luego ponerla como parametro de configuración del proyecto u otra alternativa.
            strCadenaDeConexion = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=TiendaTP;Data Source=MICAELA\SQLEXPRESS";
        ...
        internal DataTable LeerPorComando(string consulta, SqlParameter[] parametros)
        {
